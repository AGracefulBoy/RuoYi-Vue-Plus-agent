package org.dromara.common.llm.model.platform.alibaba.converter;
...
public class AlibabaChatResponseConverter {
    /**
    ...
    public static IChatResponse convert(ChatResponse chatResponse) {
        ...
        if (chatResponse.getResult() != null && chatResponse.getResult().getOutput() != null) {
            String reasoningContent = String.valueOf(chatResponse.getResult().getOutput().getMetadata().get("reasoningContent"));
            if (StringUtils.hasText(reasoningContent)) {
                output.setReasoningContent(chatResponse.getResult().getOutput().getMetadata().get("reasoningContent"));
                output.setText(null);
            } else {
                output.setReasoningContent(null);
